<fieldset>
    ...
    <div class="control-group<?php echo form_error('allow_register') ? $errorClass : ''; ?>">
        <div class="controls">
            <label class='i-checks' for="allow_register">
    ...
    <div class="control-group">
        ...
        <div class="controls" aria-labelledby="use_usernames_label" role="group">
            <label class="i-checks" for="use_username">
            ...
            <label class="i-checks" for="use_email">
    ...
    <div class="control-group">
        ...
        <div class="controls" aria-labelledby='allow_name_change_label' role='group'>
            <label class="i-checks"  for="allow_name_change">
    ...
    <div class="control-group">
        <div class="controls">
            <label class="i-checks"  for="allow_remember">
    ...
    <div class="control-group">
        ...
        <div class="controls" aria-labelledby='password_options_label' role='group'>
            <label class="i-checks"  for="password_force_numbers">
            ...
            <label class="i-checks"  for="password_force_symbols">
            ...
            <label class="i-checks"  for="password_force_mixed_case">
            ...
            <label class="i-checks"  for="password_show_labels">
