<fieldset>
    ...
    <div class="control-group<?php echo form_error('list_limit') ? $errorClass : ''; ?>">
        ...
        <div class="controls">
            <input type="text" name="list_limit" class="form-control" id="list_limit" value="<?php echo set_value('list_limit', isset($settings['site.list_limit']) ? $settings['site.list_limit'] : ''); ?>" class="span1" />
