...
class Settings extends Admin_Controller
{
	...
	function index()
	{
		...
		$this->pager['cur_tag_open'] = '<li class="active"><span><a href="">';
		$this->pager['cur_tag_close'] = '</a></span></li>';
	...
	private function save_permissions($type='insert', $id=0)
	{
		...
		$this->form_validation->set_rules('name','lang:bf_name','required|trim|max_length[130]');
