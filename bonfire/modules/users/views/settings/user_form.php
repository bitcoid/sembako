...
?>
    <fieldset>
		...
		<input type="text" class="form-control"  name="jabatan" value="<?php echo @$user->jabatan?>" />
    ...
    <?php endif; ?>
	    ...
	    <label class="font-bold"> Picture  (Max Size 1 MB, 300X300 Pixel )</label> 
		<input type="file" class="form-control"  name="userfile1" /> <br><br>
		<img src="<?php echo base_url();?>upload/users/<?php echo @$user->foto?>" width="100">
